...
const UhromeBrowser = ({ id, pcConnected, miningProgress, onBetUnitCoin, onSpendMoney, money, onStartConnection, onEndConnection, onDisconnect }) => {
  ...
  const CASE_TYPES = {
    medium: {
      ...
      price: 25.00,
      items: [
        { name: 'P250 Steel Mesh', rarity: 'blue', color: '#4b69ff', value: 1.2, odds: 58.0 },
        { name: 'MP7 Ocean Foam', rarity: 'blue', color: '#4b69ff', value: 1.8, odds: 22.0 },
        { name: 'Tec-9 Reactor', rarity: 'purple', color: '#8847ff', value: 6.5, odds: 10.0 },
        { name: 'AK-47 Redline', rarity: 'purple', color: '#8847ff', value: 12.0, odds: 5.5 },
        { name: 'M4A4 Desolate Space', rarity: 'pink', color: '#d32ce6', value: 35.0, odds: 2.8 },
        { name: 'AWP Neo-Noir', rarity: 'pink', color: '#d32ce6', value: 55.0, odds: 1.3 },
        { name: 'AK-47 Vulcan', rarity: 'red', color: '#eb4b4b', value: 140.0, odds: 0.3 },
        { name: '★ Huntsman Knife', rarity: 'gold', color: '#ffd700', value: 700.0, odds: 0.1 },
      ],
    },
    high: {
      label: 'High',
      price: 100.00,
      items: [
        { name: 'M4A1-S Decimator', rarity: 'blue', color: '#4b69ff', value: 4.0, odds: 52.0 },
        { name: 'USP-S Orion', rarity: 'purple', color: '#8847ff', value: 18.0, odds: 24.0 },
        { name: 'AK-47 Frontside Misty', rarity: 'purple', color: '#8847ff', value: 30.0, odds: 12.0 },
        { name: 'AWP Hyper Beast', rarity: 'pink', color: '#d32ce6', value: 95.0, odds: 6.5 },
        { name: 'M4A1-S Printstream', rarity: 'pink', color: '#d32ce6', value: 180.0, odds: 3.2 },
        { name: 'AK-47 Fire Serpent', rarity: 'red', color: '#eb4b4b', value: 650.0, odds: 1.3 },
        { name: 'AWP Gungnir', rarity: 'red', color: '#eb4b4b', value: 1300.0, odds: 0.7 },
        { name: '★ Karambit Doppler', rarity: 'gold', color: '#ffd700', value: 4000.0, odds: 0.3 },
      ],
    },
    'really-high': {
      label: 'Really High',
      price: 500.00,
      items: [
        { name: 'USP-S Kill Confirmed', rarity: 'purple', color: '#8847ff', value: 90.0, odds: 42.0 },
        { name: 'AK-47 Fuel Injector', rarity: 'purple', color: '#8847ff', value: 140.0, odds: 27.0 },
        { name: 'AWP Oni Taiji', rarity: 'pink', color: '#d32ce6', value: 420.0, odds: 14.0 },
        { name: 'M4A4 Howl (Replica)', rarity: 'pink', color: '#d32ce6', value: 850.0, odds: 8.0 },
        { name: 'AK-47 Wild Lotus', rarity: 'red', color: '#eb4b4b', value: 2800.0, odds: 5.0 },
        { name: 'AWP Dragon Lore', rarity: 'red', color: '#eb4b4b', value: 6000.0, odds: 2.2 },
        { name: '★ M9 Bayonet Sapphire', rarity: 'gold', color: '#ffd700', value: 18000.0, odds: 1.3 },
        { name: '★ Karambit Ruby', rarity: 'gold', color: '#ffd700', value: 32000.0, odds: 0.5 },
      ],
    },
    'really-really-high': {
      ...
      price: 2500.00,
      items: [
        { name: 'AK-47 Gold Arabesque', rarity: 'pink', color: '#d32ce6', value: 1800.0, odds: 46.0 },
        { name: 'M4A4 Poseidon', rarity: 'pink', color: '#d32ce6', value: 3200.0, odds: 27.0 },
        { name: 'AWP Medusa', rarity: 'red', color: '#eb4b4b', value: 9000.0, odds: 14.0 },
        { name: 'AK-47 Case Hardened #661', rarity: 'red', color: '#eb4b4b', value: 22000.0, odds: 7.0 },
        { name: '★ Butterfly Knife Emerald', rarity: 'gold', color: '#ffd700', value: 65000.0, odds: 3.5 },
        { name: '★ Karambit Blue Gem', rarity: 'gold', color: '#ffd700', value: 120000.0, odds: 1.6 },
        { name: '★ M9 Bayonet Blue Gem', rarity: 'gold', color: '#ffd700', value: 250000.0, odds: 0.9 },
      ],
    },
  };
